 ...
 */
public class TriviaCategoryBox extends Fragment {
    ...
    public static TriviaCategoryBox newInstance(String param1, String param2) {
    ...
    public void setHeader(String text){
        TextView textView = (TextView) getView().findViewById(R.id.trivia_category_header);
